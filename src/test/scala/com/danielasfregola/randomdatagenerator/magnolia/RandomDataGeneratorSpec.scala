...
class RandomDataGeneratorSpec extends SpecificationLike {
  ...
  "RandomDataGenerator" should {
    ...
    "Magnolia" in {
      ...
      arbitraryExample.arbitrary.sample.get should beAnInstanceOf[Example]
    }
...
//      import scalacheckmagnolia.MagnoliaArbitrary._
//
//      val a = implicitly[Arbitrary[Example]]
//
//      val instance = random[Example](a)
//
